...
export default function ChangePass() {
    ...
    return (
        <div className="min-h-screen flex justify-center items-center relative overflow-hidden py-16">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-teal-900/20 via-slate-900 to-slate-950" />
            <div className="absolute top-24 right-1/4 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl animate-[float_6s_ease-in-out_infinite]" />
            <div className="absolute bottom-24 left-1/4 w-72 h-72 bg-teal-500/10 rounded-full blur-3xl animate-[float_7s_ease-in-out_infinite_reverse]" />
                ...
                <div className="backdrop-blur-xl bg-slate-800/60 border border-slate-600/50 rounded-2xl p-8 shadow-2xl shadow-black/30">
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-2" style={{ animation: 'slide-left 0.5s ease-out 0.3s forwards', opacity: 0 }}>
                            <label className="block text-sm font-medium text-slate-300">Old Password</label>
                            <input
                                type="password"
